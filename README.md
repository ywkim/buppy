...
또한, Buppy는 [buppy-dashboard.streamlit.app](https://buppy-dashboard.streamlit.app/)를 통해 웹에서도 접근 가능합니다. 이 링크를 통해 Buppy의 대시보드로 바로 이동할 수 있으며, 여기서 Buppy와의 대화를 시작하거나 관리할 수 있습니다. 이 대시보드는 관리자가 Buppy의 설정을 쉽게 관리하고, 실시간 대화를 모니터링할 수 있는 기능을 제공합니다.
